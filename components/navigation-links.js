    ...
    <>
      ...
      >
        <div className="navigation-links-links">
          <Link href="/">
            <a className="navigation-links-link2 navLink">{props.link}</a>
          </Link>
          <Link href="/">
            <a className="navigation-links-link4 navLink">{props.link1}</a>
          </Link>
          <Link href="/">
            <a className="navigation-links-link6 navLink">{props.link2}</a>
          </Link>
          <Link href="/">
            <a className="navigation-links-link8 navLink">{props.link3}</a>
          </Link>
        </div>
